...
func New(db LogDB, logTableName string) *Logger {
...
func (l *Logger) insertLog(msg Msg) {
	...
	if l.InsertCnt == 0 {
		...
		l.sqlBuilder.WriteString(fmt.Sprintf("INSERT INTO %v(`msg_type`,`msg_err`, `round_height`, `height`, `addr`, `addr2`, `msg`, `insert_time`) VALUES (\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\")", l.logTableName, msg.msgType, msg.msgErr, msg.roundHeight, msg.height, msg.addr, msg.addr2, msg.content, msg.insertTime.Format("2006-01-02 15:04:05.000")))
	} else {
		l.sqlBuilder.WriteString(fmt.Sprintf(",(\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\",\"%v\")", msg.msgType, msg.msgErr, msg.roundHeight, msg.height, msg.addr, msg.addr2, msg.content, msg.insertTime.Format("2006-01-02 15:04:05.000")))
	}
	l.InsertCnt++
}
